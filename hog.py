...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if s - previous_score > previous_high:
            high = s - previous_score
            print(high, "point(s)! That's the biggest gain yet for Player",
                  who)
        else:
            high = previous_high
        return announce_highest(who, high, s)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    4) Chage the parameters to maximize the win rate.
    !!!:
    5) Avoid being swapped when taking the lead.(most important)
    """
    # Your hog final win rate: 0.6810509809697703
    # BEGIN PROBLEM 12
    ...
    if score + 1 == 100 and not is_swap(score + 1, opponent_score):
        return 10
    ...
    elif 1 in bad or ((7 in bad or 8 in bad or 9 in bad or 10 in bad) and
                      (score > GOAL_SCORE - 7 or score - opponent_score > 23)):
        if not (free in bad):
            return 0
        else:
            return 1
